							...
							<div class="mainmenu">
								<nav>
									<ul>
										...
										<li class="expand"><a href="{{asset('view')}}">Sản phẩm</a>
											<ul class="restrain sub-menu">
												
												@foreach($catelist as $cate)
												<li><a href="{{asset('view/'.$cate->id.'/'.$cate->c_slug.'.html')}}">{{$cate->c_name}}</a></li>
												@endforeach		
									...
									<div class="header-search expand">
										...
										<div class="product-search restrain">
											<div class="container nopadding-right">
												<form action="{{asset('view/search/')}}" id="searchform" method="get">
													<div class="input-group">
														<input type="text" class="form-control" maxlength="128" placeholder="Bạn muốn tìm gì..." name="result">
			...
			<div class="slider-area an-1 hm-1">
				...
				<div class="bend niceties preview-2">
					<div id="ensign-nivoslider" class="slides">	
						<img src="{{asset('layout/frontend/img/slider/home-1/slider1-2.png')}}" alt="" title="#slider-direction-1"  />
						<img src="{{asset('layout/frontend/img/slider/home-1/slider1-1.png')}}" alt="" title="#slider-direction-2"  />
						<img src="{{asset('layout/frontend/img/slider/home-1/silder1-3.png')}}" alt="" title="#slider-direction-2"  />
					</div>
				</div>
				<!-- slider end-->
			</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-6 col-xs-12">
								<address><a href="http://actvn.edu.vn/">Học Viện Kỹ Thuật Mật Mã</a></address>
							</div>
							<div class="col-md-6 col-xs-12">
